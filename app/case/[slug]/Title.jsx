...
const Title = ({ projectName, desc }) => {
  return (
    <main className="bg-white-800 dark:bg-black-300 flex items-center justify-center pb-[140px] md:pb-[90px] lg:pb-[60px] mt-[80px]">
      <div className="max-w-[1440px] relative pt-[60px] md:pt-[110px] flex items-center justify-center px-6 w-full">
        ...
        <section className="absolute z-20 left-1/2 top-[90px] -translate-x-1/2 w-full px-6">

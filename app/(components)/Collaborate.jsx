  ...
  return (
    <main className="flex items-center justify-center">
      <div className="max-w-[1440px] w-full px-6 py-[70px]">
        <section className="bg-collabbg bg-center object-contain bg-no-repeat h-[330px] bg-blue-secondary rounded-[20px] relative flex flex-col items-center justify-center gap-12 px-6 md:px-0">
          ...
          <Link href="/contact" className="w-full sm:w-[323px]">
